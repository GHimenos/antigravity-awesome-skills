<!-- registry-sync: version=10.3.0; skills=1426; stars=33561; updated_at=2026-04-17T09:02:57+00:00 -->
# 🌌 Antigravity Awesome Skills: 1,426+ Agentic Skills for Claude Code, Gemini CLI, Cursor, Copilot & More

> **Installable GitHub library of 1,426+ agentic skills for Claude Code, Cursor, Codex CLI, Gemini CLI, Antigravity, and other AI coding assistants.**
...
- **Broad coverage with real utility**: 1,426+ skills across development, testing, security, infrastructure, product, and marketing.
...
If you want a faster answer than "browse all 1,426+ skills", start with a tool-specific guide:
